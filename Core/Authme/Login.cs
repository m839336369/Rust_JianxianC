            ...
            if (!UnderLogin)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        string request = JianxianC.JianxianC.Instance.SendMessageToServer("AuthMeLogin-" + UserName + "-" + Password);
                        if (request == "Approved")
                        {
            ...
            if (!UnderRegister)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        string request = JianxianC.JianxianC.Instance.SendMessageToServer("AuthMeRegister-" + UserName + "-" + Password);
